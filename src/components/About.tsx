    ...
    <section id="about" className="min-h-screen py-20 px-4 lg:px-8">
      <div className="container mx-auto">
        <div className="mb-12" data-aos="fade-up">
          <h6 className="text-blue-500 dark:text-blue-400 text-sm uppercase tracking-wider mb-2">Get to know more</h6>
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <p className="text-blue-500 dark:text-blue-400 mb-1">Riga Technical University (2024 - Current)</p>
                <p className="text-gray-600 dark:text-gray-400">Riga, Latvia</p>
              </div>
            </div>
          </div>
        </div>
